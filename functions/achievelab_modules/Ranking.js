...
async function ranking(teamName) {
    try {
        ...
        const q = query(usersCollectionRef, where(`team_points.${teamName}`, '>', 0));
        ...
        querySnapshot.forEach((userDoc) => {
            ...
            usersData.push({
                id: userDoc.id,
                team_points: userData.team_points && userData.team_points[teamName] ? userData.team_points[teamName] : 0,
            });
        });
